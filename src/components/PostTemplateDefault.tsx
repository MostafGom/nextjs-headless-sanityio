...
export default async function PostTemplateDefault({ postContent }: any) {
        ...
        <section className="flex flex-col items-center justify-center w-full bg-cover bg-center dark:bg-gray-900 light:bg-gray-400 dark:text-white text-black px-4 relative p-8">
            ...
            <div className="container  max-w-5xl">
                <div className="mt-4 ml-0 md:mx-auto">
                    <Image src={urlForSanityImage(postContent.mainImage).width(500).url()} alt="hello" width={500} height={500} className='rounded-mycustomrounded ml-0 md:mx-auto w-full' />
                </div>
            </div>
